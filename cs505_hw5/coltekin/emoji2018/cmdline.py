def add_args(ap, groups):
    ...
    if 'general' in groups:
        ap.add_argument("-train", "--train", dest="train_prefix")
        # ap.add_argument("-train_y", "--train_y", dest="i_train_label")
        ap.add_argument("-test", "--test", dest="test_prefix")
        ap.add_argument("-mapping", "--mapping", dest="mapping_path")

        # ap.add_argument("-test_y", "--test_y", dest="i_test_label")
