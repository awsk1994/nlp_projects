...
print("c1 | train data prefix={}, test data prefix={}".format(opt.train_prefix, opt.test_prefix))

# data = load(opt.input_prefix)
train_x = load(opt.train_prefix, opt.mapping_path)
# train_y = load(opt.i_train_label)
test_x = load(opt.test_prefix, opt.mapping_path)
# test_y = load(opt.i_test_label)

# print(train_x.labels)

docs, v, _ = doc_to_ngrams(train_x.docs, min_df=opt.min_df,
                          ...
                          input_name = opt.train_prefix)
labels = np.array(train_x.labels)
